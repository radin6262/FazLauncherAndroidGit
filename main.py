...
GAMES = [
    {
        ...
        "android_url": "https://github.com/radin6262/FazLauncherSite/raw/refs/heads/main/five-nights-at-freddy.apk?download=true",
    ...
    main_content = ft.Stack([
        ft.Container(
            content=ft.Column([
                ...
                ft.Container(
                    content=ft.Text(
                        "FazLauncher - Copyright 2026 all rights reserved",
